...
<%@ attribute name="ajax" type="java.lang.String" required="true" description="The path to the JSP that processes the AJAX call." %>
<%@ attribute name="path" type="java.lang.String" required="true" description="The path to the images that will be shown." %>
<%@ attribute name="searchconf" type="java.lang.String" required="true" description="The search configuration string used to find gallery elements." %>
<%@ attribute name="count" type="java.lang.String" required="true" description="The amount of images that are appended to the gallery with every load cycle." %>
