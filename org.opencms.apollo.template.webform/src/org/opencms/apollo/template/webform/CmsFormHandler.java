...
public class CmsFormHandler extends CmsJspActionElement {
    ...
    public void createForm() throws IOException, ServletException {
        ...
        StringTemplate sTemplateJS = getOutputTemplate("form_js");
        sTemplateJS.setAttribute("formconfig", getFormConfiguration());
        sTemplateJS.setAttribute("sessionjs", sessionJs);
        sTemplateJS.setAttribute("sessionuri", link(modulePath + "elements/keepsession.jsp"));
        sTemplateJS.setAttribute("subfieldjs", link(modulePath + "resources/js/subfields.js"));
        out.write(sTemplateJS.toString());
        ...
        if (captchaField != null) {
            ...
            sTemplate.setAttribute(
                ...
                OpenCms.getLinkManager().substituteLink(
                    getCmsObject(),
                    "/system/modules/org.opencms.apollo.template.webform/elements/captcha.jsp?"
    ...
    protected boolean sendMail() {
        ...
        try {
            ...
            if (getFormConfiguration().getMailType().equals(CmsForm.MAILTYPE_HTML)) {
                ...
                theMail.setTo(
                    createInternetAddresses(m_macroResolver.resolveMacros(getFormConfiguration().getMailTo())));
