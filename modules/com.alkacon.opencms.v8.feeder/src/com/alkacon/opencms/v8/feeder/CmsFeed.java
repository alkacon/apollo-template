/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.feeder/src/com/alkacon/opencms/v8/feeder/CmsFeed.java,v $
...
public class CmsFeed {
    ...
    public static final String NODE_SCHEMA = "AlkaconV8Feeds";
    ...
    private static final Log LOG = CmsLog.getLog(CmsFeed.class);
    ...
    throws CmsException, CmsDataAccessException {
        ...
        LOG.debug("RSS Feed using collector \"" + collectorStr + "\" with parameter \" + params + \"");
        LOG.debug("RSS Feed found " + entries.size() + "possible entries.");
