...
<cms:formatter var="content" val="value">
	<div class="slider-container mb-20" style="overflow: hidden;">
		<div class="slider">
			<c:choose>
				...
				<c:otherwise>
					<ul>
						<c:forEach var="image" items="${content.valueList.Image}"
							...
							<li style="display: none;" data-masterspeed=" ${value.Delay}" data-transition="fade"
								data-slotamount="12"><c:if test="${image.value.Link.isSet}">
								...
								alt="${image.value.Tooltip}" /> <c:if
									...
									<div class="hidden-xs caption fade" data-x="${x}" data-y="${y}"
