	...
	<div class="ap-slider">
		<c:choose>
			<c:when test="${cms.element.inMemoryOnly}">
				<div class="alert alert-danger"><fmt:message key="apollo.slider.message.new" /></div>
			</c:when>
			<c:when test="${cms.edited}">
				<div>${cms.enableReload}</div>
				<div class="alert alert-danger"><fmt:message key="apollo.slider.message.edited" /></div>
			</c:when>
			<c:otherwise>
